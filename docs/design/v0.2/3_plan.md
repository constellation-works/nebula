...
| # | task | depends on | crew | id |
|---|---|---|---|---|
| A | Schema cut + `neb migrate` ([1_spec.md](1_spec.md) "What is removed", "Migration") | — | opus | DANI-10345 |
| B | Cargo workspace: `crates/nebula-core` + `crates/neb`, typed errors, `graph` module, `neb graph --json` ([2_architecture.md](2_architecture.md)) | A | opus | DANI-10346 |
| C | Docs rewrite: `docs/spec.md`, `docs/design/lineage-graph/*`, runbooks, README, CHANGELOG to v0.2 | A | sonnet | DANI-10347 |
| D | `skills/nebula/SKILL.md` + references | A | sonnet | DANI-10348 |
| E | Desktop scaffold: Tauri 2 + React, `src-tauri` on core, tray, global-shortcut capture, inbox view, CI for the frontend | B | opus | DANI-10349 |
| F | Desktop graph view: elkjs layout, node panel, tag filter, file watcher | E | opus | DANI-10350 |
